...
import com.healthchain.backend.model.Enrollment;
...
//     * @return
//     */
//    private User buildAdminUser(String hospName, X509Identity adminId) {
//        HospInfo hospInfo = networkProps.getHospInfoByName().get(hospName);
//        return User.builder()
...
//    }
    ...
    public void enrollAdmin(String hospName) {
        ...
        try {
            ...
            Enrollment enrollment = (Enrollment) caClient.enroll(networkProps.getHospInfoByName().get(hospName).getUsername(),
