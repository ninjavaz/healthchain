...
public class RegisterUser {
	...
	public static void main(String[] args) throws Exception {
		...
		if (wallet.get("user2") != null) {
			System.out.println("An identity for the user \"user2\" already exists in the wallet");
			return;
		}

		X509Identity adminIdentity = (X509Identity)wallet.get("hosp1admin");
		if (adminIdentity == null) {
			System.out.println("\"hosp1admin\" needs to be enrolled and added to the wallet first");
			return;
		}
		User admin = new User() {
...
//		registrationRequest.setAffiliation("org1.department1");
		...
		Identity user = Identities.newX509Identity("hosp1MSP", adminIdentity.getCertificate(), adminIdentity.getPrivateKey());
